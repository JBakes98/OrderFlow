...
docker build -t "000000000000.dkr.ecr.eu-west-1.localhost.localstack.cloud:4566/orderflow-api" . -f src/OrderFlow.Api/Dockerfile
docker push "000000000000.dkr.ecr.eu-west-1.localhost.localstack.cloud:4566/orderflow-api"
